      ...
      <Modal title={t.addVehicle||"Ajouter un véhicule"} onClose={()=>setModal(false)}>
          ...
          <div style={{ display:"flex", gap:10, justifyContent:"flex-end", marginTop:22 }}>
            ...
            <Btn label={t.add||"Ajouter"} onClick={async ()=>{
              const newV = { utilisateur_id: user.id, nom: form.name, plaque: form.plate, carburant: form.fuel, transmission: form.trans, km: parseInt(form.e_per_day: parseInt(form.price)||0, année: parseInt(form.year)||2023, catégorie: form.cat, statut: "disponible", photo_url: form.photo };
